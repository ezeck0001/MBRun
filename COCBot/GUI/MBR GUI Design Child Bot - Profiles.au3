...
Local $x = 25, $y = 45
	$grpProfiles = GUICtrlCreateGroup(GetTranslated(637,1, "Switch Profiles"), $x - 22, $y - 20, 444, 362)
		;$y -= 5
		$x -= 5
...
; SwitchAcc - DEMEN
	Local $x = 25, $y = 135
	$grpSwitchAcc = GUICtrlCreateGroup("Switch Account Mode", $x - 20, $y - 20, 222, 270)
		...
		$lblTotalAccount = GUICtrlCreateLabel("Total CoC Acc:", $x + 15, $y + 27, -1, -1)
		...
		$radSmartSwitch= GUICtrlCreateRadio("Smart switch", $x + 15 , $y + 50, -1, 16)
			GUICtrlSetTip(-1, "Switch to account with the shortest remain training time")
			GUICtrlSetState(-1, $GUI_CHECKED)
			GUICtrlSetState(-1, $GUI_DISABLE)

		$radNormalSwitch = GUICtrlCreateRadio("Normal switch", $x + 100, $y + 50, -1, 16)
	    ...
	    $chkRestartAndroidSearchLimit = GUICtrlCreateCheckbox("Restart Android every" & ":", $x, $y + 20, -1, -1)
		...
		$txtRestartAndroidSearchLimit = GUICtrlCreateInput("200", $x + 20, $y + 43, 30, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetLimit(-1, 4)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$lblRestartAndroidSearchLimit = GUICtrlCreateLabel("Search(es)", $x + 57, $y + 45, -1, -1)

		$chkIdleAfter = GUICtrlCreateCheckbox("Idle Account When:", $x, $y + 63, -1, -1)
			GUICtrlSetState(-1, $GUI_UNCHECKED)
			GUICtrlSetOnEvent(-1, "chkIdleAfter")

		$picGoldLoot1 = GUICtrlCreateIcon($pIconLib, $eIcnGold, $x + 25, $y + 85, 16, 16)
		$lblIdleafter1 = GUICtrlCreateLabel("> =", $x + 50, $y + 85, -1, -1)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$txtIdleGoldLimit = GUICtrlCreateInput("7500000", $x + 75, $y + 85, 60, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetState(-1, $GUI_DISABLE)
		$lblIdleafter2 = GUICtrlCreateLabel("And", $x + 50, $y + 99, -1, -1)
			GUICtrlSetState(-1, $GUI_DISABLE)

		$picElixirLoot1 = GUICtrlCreateIcon($pIconLib, $eIcnElixir, $x + 25, $y + 113, 16, 16)
		$lblIdleafter3 = GUICtrlCreateLabel("> =", $x + 50, $y + 113, -1, -1)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$txtIdleElixerLimit = GUICtrlCreateInput("7500000", $x + 75, $y + 111, 60, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetState(-1, $GUI_DISABLE)

		$lblIdleafter4 = GUICtrlCreateLabel("And", $x + 50, $y + 127, -1, -1)
			GUICtrlSetState(-1, $GUI_DISABLE)

		$picDarkLoot1 = GUICtrlCreateIcon($pIconLib, $eIcnDark, $x + 25, $y + 139, 16, 16)
		$lblIdleafter5 = GUICtrlCreateLabel("> =", $x + 50, $y + 139, -1, -1)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$txtIdleDELimit = GUICtrlCreateInput("1000", $x + 75, $y + 137, 60, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetState(-1, $GUI_DISABLE)
			
		$lblWarPrep12 = GUICtrlCreateLabel("Switch Account Conflicts with War Prep Delay" , $x - 18 , $y + 160, -1, -1)
    ...
    Local $x = 250, $y = 135
	  $grpSwitchAccMapping = GUICtrlCreateGroup("Profiles", $x - 20, $y - 20, 215, 270)
